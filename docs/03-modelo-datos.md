...
- **RecordingProfile** — "receta" de codificación (`PresetName` = nombre del preset con el que se rellenó, para el badge del canal; NULL en filas anteriores, donde se muestra el resumen técnico): códecs, bitrate, GOP, contenedor, overlays,
